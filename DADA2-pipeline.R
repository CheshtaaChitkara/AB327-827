...
## !< unzipping .gz files
zipf<- list.files(path = "C:/Users/cheshtaac/Documents/git/AB327-827/fastq", pattern= "*.gz", full.names=TRUE)
ldply(.data = zipf, .fun=gunzip) # removes the compressed file, replaces with fastq
